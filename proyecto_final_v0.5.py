...
from PySide6.QtWidgets import (
    ...
    QLineEdit, QFileDialog, QTextEdit, QHBoxLayout, QMessageBox, QMenuBar, QStatusBar
)
...
class FileOrganizer(QMainWindow):
    def __init__(self):
        ...
        # Menú Archivo
        archivo_menu = self.menu_bar.addMenu("Archivo")
        ...
        acerca_de_action = QAction("Acerca de OrgaFile", self)
        ...
        self.status_bar.showMessage("Versión 0.5 - OrgaFile")
    ...
    def organize_files(self):
        ...
        archivos_organizados = 0 #Cuenta los archivos organizados
        ...
        self.status_bar.showMessage(f"{archivos_organizados} archivo(s) organizados.") #actualiza la barra de estado
    ...
    def mostrar_acerca_de(self):
        QMessageBox.information(
            self,
            "Acerca de OrgaFile",
            "OrgaFile v0.5\n\nOrganiza tus archivos por tipo y encuentra los más pesados fácilmente.\n\nDesarrollado por Miguel Ángel Mosquera y Fernando Lopez"
        )
